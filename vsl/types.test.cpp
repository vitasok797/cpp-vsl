...
TEST(TypesTest, Constants)
{
    ...
    EXPECT_EQ(vsl::PTRDIFF_T_MIN, INT64_MIN);
    EXPECT_EQ(vsl::PTRDIFF_T_MAX, INT64_MAX);

    EXPECT_EQ(vsl::SIZE_T_MAX, UINT64_MAX);
...
TEST(TypesTest, CheckedCastBool)
{
    EXPECT_EQ(vsl::checked_cast<bool>(i8{0}), false);
    EXPECT_EQ(vsl::checked_cast<bool>(i8{1}), true);

    EXPECT_EQ(vsl::checked_cast<bool>(float{0.0f}), false);
    EXPECT_EQ(vsl::checked_cast<bool>(float{1.0f}), true);

    EXPECT_EQ(vsl::checked_cast<bool>(double{0.0}), false);
    EXPECT_EQ(vsl::checked_cast<bool>(double{1.0}), true);

    EXPECT_THROW(vsl::checked_cast<bool>(i8{2}), vsl::NarrowingError);

    EXPECT_THROW(vsl::checked_cast<bool>(float{1.1f}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<bool>(double{1.1}), vsl::NarrowingError);
}

TEST(TypesTest, CheckedCastFloating)
{
    EXPECT_EQ(vsl::checked_cast<float>(bool{false}), 0.0f);
    EXPECT_EQ(vsl::checked_cast<float>(bool{true}), 1.0f);
    EXPECT_EQ(vsl::checked_cast<double>(bool{false}), 0.0);
    EXPECT_EQ(vsl::checked_cast<double>(bool{true}), 1.0);

    EXPECT_EQ(vsl::checked_cast<float>(i32{7}), 7.0f);
    EXPECT_EQ(vsl::checked_cast<double>(i32{7}), 7.0);

    EXPECT_EQ(vsl::checked_cast<float>(u32{7}), 7.0f);
    EXPECT_EQ(vsl::checked_cast<double>(u32{7}), 7.0);

    EXPECT_EQ(vsl::checked_cast<float>(i32{-7}), -7.0f);
    EXPECT_EQ(vsl::checked_cast<double>(i32{-7}), -7.0);

    EXPECT_THROW(vsl::checked_cast<float>(vsl::U32_MAX), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<double>(vsl::U64_MAX), vsl::NarrowingError);

    EXPECT_THROW(vsl::checked_cast<i32>(std::numeric_limits<double>::quiet_NaN()), vsl::NarrowingError);
}

TEST(TypesTest, CheckedCastSigned)
{
    EXPECT_EQ(vsl::checked_cast<i16>(bool{false}), 0);
    EXPECT_EQ(vsl::checked_cast<i16>(bool{true}), 1);

    EXPECT_EQ(vsl::checked_cast<i16>(i8{0}), 0);
    EXPECT_EQ(vsl::checked_cast<i16>(i16{0}), 0);
    EXPECT_EQ(vsl::checked_cast<i16>(i32{0}), 0);

    EXPECT_EQ(vsl::checked_cast<i16>(u8{0}), 0);
    EXPECT_EQ(vsl::checked_cast<i16>(u16{0}), 0);
    EXPECT_EQ(vsl::checked_cast<i16>(u32{0}), 0);

    EXPECT_EQ(vsl::checked_cast<i16>(i8{7}), 7);
    EXPECT_EQ(vsl::checked_cast<i16>(i16{7}), 7);
    EXPECT_EQ(vsl::checked_cast<i16>(i32{7}), 7);

    EXPECT_EQ(vsl::checked_cast<i16>(i8{-7}), -7);
    EXPECT_EQ(vsl::checked_cast<i16>(i16{-7}), -7);
    EXPECT_EQ(vsl::checked_cast<i16>(i32{-7}), -7);

    EXPECT_EQ(vsl::checked_cast<i16>(u8{7}), 7);
    EXPECT_EQ(vsl::checked_cast<i16>(u16{7}), 7);
    EXPECT_EQ(vsl::checked_cast<i16>(u32{7}), 7);

    EXPECT_EQ(vsl::checked_cast<i16>(vsl::I16_MIN), vsl::I16_MIN);
    EXPECT_EQ(vsl::checked_cast<i16>(vsl::I16_MAX), vsl::I16_MAX);
    EXPECT_THROW(vsl::checked_cast<i16>(i32{vsl::I16_MIN - 1}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<i16>(i32{vsl::I16_MAX + 1}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<i16>(u16{vsl::I16_MAX + 1}), vsl::NarrowingError);

    EXPECT_EQ(vsl::checked_cast<i16>(float{7.0f}), 7);
    EXPECT_EQ(vsl::checked_cast<i16>(double{7.0}), 7);
    EXPECT_EQ(vsl::checked_cast<i16>(float{-7.0f}), -7);
    EXPECT_EQ(vsl::checked_cast<i16>(double{-7.0}), -7);
    EXPECT_EQ(vsl::checked_cast<i16>(double{1e4}), 10000);
    EXPECT_EQ(vsl::checked_cast<i16>(double{-1e4}), -10000);
    EXPECT_THROW(vsl::checked_cast<i16>(float{1.1f}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<i16>(double{1.1}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<i16>(double{1e5}), vsl::NarrowingError);
}

TEST(TypesTest, CheckedCastUnsigned)
{
    EXPECT_EQ(vsl::checked_cast<u16>(bool{false}), 0);
    EXPECT_EQ(vsl::checked_cast<u16>(bool{true}), 1);

    EXPECT_EQ(vsl::checked_cast<u16>(i8{0}), 0);
    EXPECT_EQ(vsl::checked_cast<u16>(i16{0}), 0);
    EXPECT_EQ(vsl::checked_cast<u16>(i32{0}), 0);

    EXPECT_EQ(vsl::checked_cast<u16>(u8{0}), 0);
    EXPECT_EQ(vsl::checked_cast<u16>(u16{0}), 0);
    EXPECT_EQ(vsl::checked_cast<u16>(u32{0}), 0);

    EXPECT_EQ(vsl::checked_cast<u16>(i8{7}), 7);
    EXPECT_EQ(vsl::checked_cast<u16>(i16{7}), 7);
    EXPECT_EQ(vsl::checked_cast<u16>(i32{7}), 7);

    EXPECT_THROW(vsl::checked_cast<u16>(i8{-1}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<u16>(i16{-1}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<u16>(i32{-1}), vsl::NarrowingError);

    EXPECT_EQ(vsl::checked_cast<u16>(u8{7}), 7);
    EXPECT_EQ(vsl::checked_cast<u16>(u16{7}), 7);
    EXPECT_EQ(vsl::checked_cast<u16>(u32{7}), 7);

    EXPECT_EQ(vsl::checked_cast<u16>(vsl::U16_MAX), vsl::U16_MAX);
    EXPECT_THROW(vsl::checked_cast<u16>(i32{vsl::U16_MAX + 1}), vsl::NarrowingError);

    EXPECT_EQ(vsl::checked_cast<u16>(float{7.0f}), 7);
    EXPECT_EQ(vsl::checked_cast<u16>(double{7.0}), 7);
    EXPECT_EQ(vsl::checked_cast<u16>(double{1e4}), 10000);
    EXPECT_THROW(vsl::checked_cast<u16>(float{-1.0f}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<u16>(double{-1.0}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<u16>(float{1.1f}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<u16>(double{1.1}), vsl::NarrowingError);
    EXPECT_THROW(vsl::checked_cast<u16>(double{1e5}), vsl::NarrowingError);
}
